...
public class DynamicDesc implements Serializable {
	...
	public static String getBytecodeDesc(List<ClassHook> classes, String name) {
		...
		for (ClassHook c : classes) {
			String obf = c.getObfuscated();
			String ref = c.getRefactored();
	...
	// System.out.println(convertSingleJavaStyle(classes, "[[I"));
	// System.out.println(convertSingleJavaStyle(classes, "[[[I"));
	// System.out.println(convertSingleJavaStyle(classes, "Ljava/lang/String;"));
	// System.out.println(convertSingleJavaStyle(classes, "[Ljava/lang/String;"));
	//
	// System.out.println(convertMultiJavaStyle(classes, "(IBLjava/lang/String;)Ljava/lang/Throwable;"));
	// System.out.println(convertMultiJavaStyle(classes, "([Ljava/lang/Throwable;Ljava/lang/String;I[IBS[Ljava/io/IOException;)V"));
	//
	// System.out.println("-------------------------------------------");
	//
	...
	// System.out.println(convertSingleBytecodeStyle(classes, "[[I"));
	// System.out.println(convertSingleBytecodeStyle(classes, "[[[I"));
	// System.out.println(convertSingleBytecodeStyle(classes, "Ljava/lang/String;"));
	// System.out.println(convertSingleBytecodeStyle(classes, "[Ljava/lang/String;"));
	//
	// System.out.println(convertMultiBytecodeStyle(classes, "(IBLjava/lang/String;)Ljava/lang/Throwable;"));
	// System.out.println(convertMultiBytecodeStyle(classes, "([Ljava/lang/Throwable;Ljava/lang/String;I[IBS[Ljava/io/IOException;)V"));
	// }
