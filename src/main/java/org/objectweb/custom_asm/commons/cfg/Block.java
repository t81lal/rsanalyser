...
public class Block implements Comparable<Block> {
    ...
    public final org.objectweb.custom_asm.Label label;
     ...
     */
    public Block(org.objectweb.custom_asm.Label label) {
        this.label = label;
        this.instructions.add(new org.objectweb.custom_asm.tree.LabelNode(label));
    }
    ...
    public String toString() {
        ...
        if(PRINT_INSNS && size() > 0) {
        	...
        	while(it.hasNext()) {
        		...
        		if(!(ain instanceof org.objectweb.custom_asm.tree.LabelNode)) {
        			if(it.hasNext()) {
