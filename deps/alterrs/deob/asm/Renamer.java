...
public class Renamer {
	...
	private void run() throws Throwable {
		URL inputURL = new URL("jar:file:./res/input.jar!/");
		if (!new File("./res/input.jar").exists()) {
			throw new RuntimeException("Could not locate \"res/input.jar\"!");
		}
		...
		module.save(new File("./res/input2.jar"));
